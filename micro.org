...
** DONE Hugo update broke my website
   CLOSED: [2019-04-12 Fri 14:18]
:PROPERTIES:
:EXPORT_FILE_NAME: hugo-update
:END:
Great. Just when I was trying to recompile my Hugo website I noticed that the
0.54->0.55 upgrade just broke everything! And we can see [[https://github.com/gohugoio/hugo/issues/4117#issuecomment-475810894][comments like this]]. I
...
** DONE Great Python ressources
   CLOSED: [2019-04-12 Fri 18:45]
:PROPERTIES:
:EXPORT_FILE_NAME: python-ressources
:END:
[[http://www.composingprograms.com][Composing Programs]] and [[http://www.labri.fr/perso/nrougier/from-python-to-numpy/][From Python to Numpy]] are two of the most invaluable
ressources I know if you want to learn Python for real. =#python=

** DONE Exit DataCamp
   CLOSED: [2019-04-12 Fri 18:48]
:PROPERTIES:
:EXPORT_FILE_NAME: exit-datacamp
:END:
Folllowing the recent scandal around DataCamp, I think [[https://www.dataquest.io][DataQuest]] and [[https://exercism.io][Exercism]]
remain good online training centers for anyone eager to learn.

** DONE Week-end misc.
   CLOSED: [2019-04-14 Sun 19:27]
:PROPERTIES:
:EXPORT_FILE_NAME: week-end-misc
:END:
