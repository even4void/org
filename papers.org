...
** Competitive programmer’s handbook ([[papers:laaksonen-2017-compet-progr-handb.pdf][laaksonen-2017-compet-progr-handb.pdf]]]])
...
In the above exmaple, the redefinition of =inc= as =inc = add 1= is an example of partial application of a curried function. Here is a more complex example:
